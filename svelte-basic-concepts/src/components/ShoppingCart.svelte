...
>
    <div class="lg:w-1/3 md:w-1/2 w-full bg-black z-50 p-6">
        ...
        {#if !hideSuggestedItem}
            <div
                class="mb-4 bg-zinc-900 px-6 py-1 flex items-center justify-between"
            >
                <div class="relative flex items-center">
                    <img
                        src={newItem.src}
                        class="h-10 bg-white mr-2"
                        alt="cup"
                    />
        ...
        {#if cartItems.length === 0}
            <div
                class="mt-20 w-full flex flex-col items-center justify-center overflow-hidden"
            >
                <div
                    class="w-16 h-16 bg-white rounded-full flex items-center justify-center"
                />
                <div class="mt-6 text-center font-bold text-2xl text-center">
                    Your cart is empty.
                </div>
            </div>
        {/if}
